...
<!-- Profile README for https://github.com/gorkenvm -->

<h1 align="center">Hi, I'm Veysel Murat Görken 👋</h1>
<p align="center">
  <b>Data Scientist & ML Engineer</b> — building RAG systems, AI agents, and multimodal apps.
</p>
...
## 💫 About me
- I work across **Data Science, Machine Learning, Big Data, and Deep Learning**.  
- Recently focused on **RAG**, **LangChain/LangGraph agents**, **finetuning**, and **multimodal** apps.  
- Comfortable with Python & data tooling: **NumPy, Pandas, scikit-learn, PyTorch/TensorFlow, MLflow**.  
- Data engineering experience with **Spark, Kafka, Hadoop/YARN**, and SQL (**Postgres/MySQL/Oracle**).  
- Tools I like: **Docker, Git, Linux/Bash, Power BI**.

---

## 🚀 Featured projects
> A few repos people usually check first.

- **[Generative-AI](https://github.com/gorkenvm/Generative-AI)** — full curriculum: multimodality, RAG, agents, finetuning, local inference.
- **[AI-Agents-in-LangGraph](https://github.com/gorkenvm/AI-Agents-in-LangGraph)** — step-by-step agents with LangGraph (ReAct → streaming → HITL).
- **[Functions-Tools-and-Agents-with-LangChain](https://github.com/gorkenvm/Functions-Tools-and-Agents-with-LangChain)** — LCEL, tools, function calling, routing.
- **[LeaderShip-Coach-Agent](https://github.com/gorkenvm/LeaderShip-Coach-Agent)** — RAG-powered leadership coach (Streamlit + APIs).
- **[Knowledge-Graphs-for-RAG](https://github.com/gorkenvm/Knowledge-Graphs-for-RAG)** — graph-aware retrieval experiments.  
<!-- Add/remove items as you prefer -->

---

## 🧰 Tech stack (condensed)
**Languages & ML:** Python • NumPy • Pandas • scikit-learn • PyTorch • TensorFlow • OpenCV • LangChain/LangGraph • MLflow  
**Data & MLOps:** Spark • Kafka • Hadoop/YARN • Airflow • Docker • Git • Linux/Bash  
**Databases:** PostgreSQL • MySQL • SQLite • MongoDB • Oracle  
**Other:** Power BI • Prompt Engineering (embeddings, finetuning)

<details>
  <summary>Show badges</summary>

  <!-- Keep badges collapsed so the page stays clean -->
  <img src="https://img.shields.io/badge/Python-3670A0?style=flat&logo=python&logoColor=ffdd54" />
  <img src="https://img.shields.io/badge/PyTorch-EE4C2C?style=flat&logo=pytorch&logoColor=white" />
  <img src="https://img.shields.io/badge/TensorFlow-FF6F00?style=flat&logo=tensorflow&logoColor=white" />
  <img src="https://img.shields.io/badge/Pandas-150458?style=flat&logo=pandas&logoColor=white" />
  <img src="https://img.shields.io/badge/scikit--learn-F7931E?style=flat&logo=scikitlearn&logoColor=white" />
  <img src="https://img.shields.io/badge/Spark-FDEE21?style=flat&logo=apachespark&logoColor=000" />
  <img src="https://img.shields.io/badge/Kafka-000?style=flat&logo=apachekafka&logoColor=white" />
  <img src="https://img.shields.io/badge/Hadoop-66CCFF?style=flat&logo=apachehadoop&logoColor=000" />
...
- **Customization & Inference:** Finetuning (LoRA/QLoRA), vector search (Chroma/FAISS/Pinecone), local inference (GGUF, llama.cpp/Ollama), multimodal (text • image • audio • video).
